...
import { SearchIcon, BellIcon, UserIcon, WalletIcon } from 'lucide-react';
export function Header() {
  return <header className="flex items-center justify-between w-full h-16 px-4 md:px-6 bg-black/60 backdrop-blur-md border-b border-white/10 z-10">
